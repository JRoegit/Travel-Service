...
function GridCard({feature} : {feature : any}){
    return(
        <div className="flex flex-row py-2 md:w-4/5">
            ...
            <div className="w-1 h-3/4 border-l-2 border-gray-400 mx-4"></div>
            <div className="flex flex-col">
                <div className="text-2xl font-bold">{feature.title}</div>
                <div className="text-lg font-medium">{feature.description}</div>
            </div>
        </div>
    )
}
